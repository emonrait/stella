...
public class StatementListAllAdapter extends RecyclerView.Adapter<StatementListAllAdapter.MyViewHolder>
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView tv_txnid, tv_invoiceno, tv_date, tv_amount, tv_email;
    ...
    public StatementListAllAdapter(Context context, ArrayList<ListItem> contactList, OnItemClickListener listener) {
